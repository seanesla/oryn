...
export type ReactBitsPrismaticBurstProps = {
  className?: string;
  style?: CSSProperties;
  intensity?: number;
  speed?: number;
...
export function ReactBitsPrismaticBurst({
  className,
  style,
  intensity = 1.4,
  speed = 0.42,
  ...
  useEffect(() => {
    ...
    program.uniforms.uAnimType.value = animTypeMap[animationType ?? "rotate"]; // default to rotate
